...
void QuadDec_Enable(void)
{
    ...
    #if (QuadDec__QUAD == QuadDec_CONFIG)
        #if (0u != QuadDec_QUAD_AUTO_START)
            QuadDec_TriggerCommand(QuadDec_MASK, QuadDec_CMD_RELOAD);
        #endif /* (0u != QuadDec_QUAD_AUTO_START) */
    #endif  /* (QuadDec__QUAD == QuadDec_CONFIG) */
}
...
*   Values:
*     - QuadDec_CMD_CAPTURE    - Trigger Capture/Switch command
*     - QuadDec_CMD_RELOAD     - Trigger Reload/Index command
*     - QuadDec_CMD_STOP       - Trigger Stop/Kill command
*     - QuadDec_CMD_START      - Trigger Start/phiB command
*
* Return:
*  None
*
