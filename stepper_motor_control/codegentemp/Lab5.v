...
module top ;
	...
	wire [0:0] tmpOE__phiA_net;
	wire [0:0] tmpIO_0__phiA_net;
	wire [0:0] tmpINTERRUPT_0__phiA_net;
	electrical [0:0] tmpSIOVREF__phiA_net;

	cy_psoc3_pins_v1_10
		#(.id("90ef04ea-3215-40f4-9a21-14c1366db25e"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		phiA
		 (.oe(tmpOE__phiA_net),
		  .y({1'b0}),
		  .fb({Net_105}),
		  .io({tmpIO_0__phiA_net[0:0]}),
		  .siovref(tmpSIOVREF__phiA_net),
		  .interrupt({tmpINTERRUPT_0__phiA_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__phiA_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__phiB_net;
	wire [0:0] tmpIO_0__phiB_net;
	wire [0:0] tmpINTERRUPT_0__phiB_net;
	electrical [0:0] tmpSIOVREF__phiB_net;

	cy_psoc3_pins_v1_10
		#(.id("e10572f3-2157-4f42-8b40-2d64e7f63aee"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		phiB
		 (.oe(tmpOE__phiB_net),
		  .y({1'b0}),
		  .fb({Net_104}),
		  .io({tmpIO_0__phiB_net[0:0]}),
		  .siovref(tmpSIOVREF__phiB_net),
		  .interrupt({tmpINTERRUPT_0__phiB_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__phiB_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("49418dad-4ef0-4ef6-89f7-e4668d8f7456"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("03ef9fed-36a3-4cea-ab83-e387a58a5569"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("07b7d181-dd39-4ac9-9d2f-27bfe83b393a"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("da3fe314-d325-4799-99cc-bea6637c3a61"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("c5c13523-416f-4039-b06b-1813e160ae53"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("c37b1d6f-9894-44e3-a62a-fb542133acba"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
    ...
    CyControlReg_v1_80 Rotor (
        ...
        .clock(1'b0),
        .reset(1'b0));
    defparam Rotor.Bit0Mode = 0;
    defparam Rotor.Bit1Mode = 0;
    defparam Rotor.Bit2Mode = 0;
    defparam Rotor.Bit3Mode = 0;
    defparam Rotor.Bit4Mode = 0;
    defparam Rotor.Bit5Mode = 0;
    defparam Rotor.Bit6Mode = 0;
    defparam Rotor.Bit7Mode = 0;
    defparam Rotor.BitValue = 0;
    defparam Rotor.BusDisplay = 0;
    defparam Rotor.ExtrReset = 0;
    defparam Rotor.NumOutputs = 4;


    assign Net_270 = Net_277 & Net_289;


    assign Net_246 = Net_280 & Net_289;


    assign Net_243 = Net_282 & Net_289;


    assign Net_272 = Net_284 & Net_289;
